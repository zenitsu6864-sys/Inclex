...
export default function HomepageCMS() {
  ...
  return (
    <AdminShell
      title="Homepage CMS"
      subtitle="Edit hero, experience, sections and banners"
      actions={
        <div className="flex items-center gap-2">
          <Link
            href="/"
            target="_blank"
            className="inline-flex items-center gap-2 rounded-sm border border-black/10 bg-white px-3 py-1.5 text-xs"
          >
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Panel title="Announcement Bar">
          <Field
            ...
            onChange={set("announcementBar")}
          />
          <Field
            label="Center coupon copy"
            value={content.couponBanner}
            onChange={set("couponBanner")}
          />
        </Panel>
        ...
        <Panel title="Hero Section">
          ...
          <Field
            ...
            value={content.heroPoster}
            onChange={set("heroPoster")}
          />
        </Panel>
        ...
        <Panel title="Experience Section">
          <Field
            ...
            onChange={set("experienceEyebrow")}
          />
          <Field
            label="Heading"
            value={content.experienceHeading}
            onChange={set("experienceHeading")}
          />
          <Field
            label="Subtitle"
            value={content.experienceSubtitle}
            onChange={set("experienceSubtitle")}
          />
          <Field
            label="Video URL (mp4)"
            value={content.experienceVideo}
            onChange={set("experienceVideo")}
          />
        </Panel>
        ...
        <Panel title="Customize Teaser">
          <Field
            label="Heading"
            value={content.customizeHeading}
            onChange={set("customizeHeading")}
          />
          <Field
            label="Subtitle"
            value={content.customizeSubtitle}
            onChange={set("customizeSubtitle")}
          />
        </Panel>
        ...
        <Panel title="Authentication Pages">
  <Field
    label="Login Banner Image"
    value={content.loginBanner || ""}
    onChange={set("loginBanner")}
  />

  <Field
    label="Signup Banner Image"
    value={content.signupBanner || ""}
    onChange={set("signupBanner")}
  />
</Panel>
