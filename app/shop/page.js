          ...
          <div className="col-span-12 md:col-span-9">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <span className="text-sm text-neutral-600">
                Showing <b className="text-black">{filtered.length}</b> product
                {filtered.length === 1 ? "" : "s"}
              </span>
              <div className="flex items-center gap-3">
                <div className="relative">
                  <select
                    ...
                    className="appearance-none rounded-sm border border-black/10 bg-white px-4 py-2 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-[#C9A227]/25"
                  >
                    {SORTS.map((s) => (
                ...
                <div className="inline-flex overflow-hidden rounded-sm border border-black/10 bg-white">
                  <button
                    ...
                    className={`px-3 py-2 ${view === "grid" ? "bg-black text-white" : ""}`}
                  >
                  ...
                  <button
                    ...
                    className={`px-3 py-2 ${view === "list" ? "bg-black text-white" : ""}`}
                  >
            ...
            <div
              className={`mt-8 grid gap-8 ${view === "grid" ? "grid-cols-1 sm:grid-cols-2 xl:grid-cols-3" : "grid-cols-1"}`}
            >
              {filtered.map((p) => (
                <motion.article
                  key={p.id}
                ...
                >
                  <Link
                    href={`/shop/${p.slug}`}
                    className={`relative block overflow-hidden bg-[#EFEDE7] ${view === "list" ? "w-72 shrink-0" : "aspect-[4/5]"}`}
                  >
                    <img
                      src={p.images[0]}
                      alt={p.name}
  ...
  <WishlistButton product={p} />
                  ...
                  <div className="p-5 flex-1">
                    ...
                    <div className="mt-2 flex items-center gap-2 text-xs text-neutral-500">
                      <span className="text-[#C9A227]">★★★★☆</span> {p.rating}{" "}
