...
export default function UserMenu({ dark }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        <span className="grid h-8 w-8 place-items-center rounded-full bg-[#C9A227] font-serif text-sm font-semibold text-black">
          {initial}
        </span>
        <ChevronDown
          ...
          <ul className="py-2">
            <li>
              <Link
                ...
                className="flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-[#F8F7F4]"
              >
                <User className="h-4 w-4 text-[#C9A227]" /> Profile
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              <Link
                ...
                className="flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-[#F8F7F4]"
              >
                <Settings className="h-4 w-4 text-[#C9A227]" /> Settings
              </Link>
            </li>
          </ul>
          <button
            ...
            className="flex w-full items-center gap-3 border-t border-black/[0.06] px-4 py-3 text-sm text-neutral-700 hover:bg-[#F8F7F4]"
          >
